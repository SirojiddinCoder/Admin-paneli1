...
export const Home = () => {
  ...
  const editCategory = (e) => {
    ...
    // formData.append("images", data.images.name); // Assuming 'images' is the key where image is stored
    ...
    .then(res => {
      if (res.success) {
        handleClose();
        getCategory(); // This line fetches updated category after editing
  ...
  return (
    <div className='container1'>
      ...
      <Modal footer={null} title="Edit" open={open1} onCancel={handleClose} onOk={handleEdit}>
    ...
    <input onChange={(e)=>setData({...data,images:e.target.files[0]})}  type="file" accept="image/*" placeholder='name ru' required/>
